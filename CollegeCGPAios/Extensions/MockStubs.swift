    ...
    static var years: [Year] {
        ...
        firstSem.courses.append(
            Course(courseName: "Mathematics", creditHours: 3.4, grade: .Bplus,
                   semesterId: firstSem.id, id: UUID().uuidString)
        )
        firstSem.courses.append(Course(courseName: "Physics", creditHours: 3.4, grade: .Bplus,
                                       semesterId: firstSem.id, id: UUID().uuidString))
        firstSem.courses.append(Course(courseName: "Image Processing", creditHours: 3.0, grade: .Aplus,
                                       semesterId: firstSem.id, id: UUID().uuidString))
        firstSem.courses.append(Course(courseName: "Machine Learning", creditHours: 3.4, grade: .Bplus,
                                       semesterId: firstSem.id, id: UUID().uuidString))
        firstSem.courses.append(Course(courseName: "Video analysis", creditHours: 3.0, grade: .Aminus,
                                       semesterId: firstSem.id, id: UUID().uuidString))
        firstSem.courses.append(Course(courseName: "Digital Logic", creditHours: 2.5, grade: .C,
                                       semesterId: firstSem.id, id: UUID().uuidString))
        ...
        secondSem.courses.append(
            Course(courseName: "Biology", creditHours: 4.0, grade: .Aplus,
                   semesterId: secondSem.id, id: UUID().uuidString)
        )
        ...
        secSemester.courses.append(
            Course(courseName: "Computer Science", creditHours: 3.4, grade: .Bplus,
                   semesterId: secSemester.id, id: UUID().uuidString)
        )
